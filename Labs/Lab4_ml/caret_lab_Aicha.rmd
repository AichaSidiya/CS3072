...
* Support Vector Machines (SVM) with a linear kernel. (Name of the methd in R: 
svmRadial)
...
```
What was the most accurate model? The most accuarate models were the KNN model with accuracy 98.3% and LDA model with accuracy 97.5% 
